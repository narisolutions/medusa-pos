...
const ErrorFallback: React.FC<FallbackProps & { config: Config }> = ({
  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center p-6 bg-white border border-slate-200 rounded-xl shadow-md w-[90%] max-w-sm">

      ...
      <div className="flex flex-col h-full space-y-8">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-500">Loading printers...</p>
          </div>
        </div>
      </div>
    );
  ...
  const renderStatus = (printer: Printer) => {
    if (testingPrinter === printer.id) {
      return (
        <div className="flex items-center space-x-3">
          ...
          <span className="text-lg text-gray-500">Testing...</span>
        </div>
      );
    }
    ...
    return (
      <div className="flex items-center space-x-3">
        ...
        <span className="text-lg text-gray-500">Unknown</span>
      </div>
    );
  };
  ...
  return (
    <div className="flex flex-col h-full space-y-8">
      ...
      {printers.length === 0 ? (
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <PrinterIcon className="h-16 w-16 text-gray-400 mx-auto mb-6" />
          ...
          <Table className="h-full">
            <TableHeader className="bg-gray-50/50 shrink-0">
              <TableRow className="border-b border-gray-200 hover:bg-transparent">
                <TableHead className="text-base font-semibold text-gray-700 py-4 px-4 first:pl-6">Name</TableHead>
                <TableHead className="text-base font-semibold text-gray-700 py-4 px-4">Type</TableHead>
                <TableHead className="text-lg font-semibold text-gray-700 py-6 px-6">Connection</TableHead>
                <TableHead className="text-lg font-semibold text-gray-700 py-6 px-6">Address</TableHead>
                <TableHead className="text-lg font-semibold text-gray-700 py-6 px-6">Status</TableHead>
                <TableHead className="text-lg font-semibold text-gray-700 py-6 px-6">Default</TableHead>
                <TableHead className="text-right text-lg font-semibold text-gray-700 py-6 px-6 last:pr-8">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody className="flex-1 overflow-auto">
              {printers.map((printer) => (
                ...
                >
                  <TableCell className="text-lg text-gray-900 py-6 px-6 first:pl-8 font-medium">
                    {printer.name}
                  </TableCell>
                  <TableCell className="text-lg text-gray-900 py-6 px-6">
                    <div className="flex items-center space-x-3">
                  ...
                  <TableCell className="text-lg text-gray-900 py-6 px-6">{renderStatus(printer)}</TableCell>
                  <TableCell className="text-lg text-gray-900 py-6 px-6">
                    {printer.isDefault && (
                  ...
                  <TableCell className="text-right text-lg text-gray-900 py-6 px-6 last:pr-8">

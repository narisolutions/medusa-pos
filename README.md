...
- Park an in-progress sale and resume it from any till
- Draft order creation and updates through Medusa Admin APIs
- Receipt printing (network / USB / system printer), cash drawer trigger
- Order list and order detail views, with refunds from the order page
